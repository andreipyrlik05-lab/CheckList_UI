...
| 12.3  | Проверка отображения формы на разных разрешениях                         | На мобильных устройствах форма адаптируется: нет горизонтального скролла, все элементы кликабельны, текст читаем.         | MEDIUM   |    |
